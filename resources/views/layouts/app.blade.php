        ...
        <nav class=" navbar navbar-expand-md navbar-light sticky-top bg-white shadow-sm" style="box-shadow: none !important;">
            <div class="container">
                <div class="d-flex align-items-center gap-4">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}" style="width: 90px;">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <div x-data="{search: false}" x-intersect="shown=true"  class="m-auto w-50 position-relative">
                        <form action="{{ route('video.search') }}" method="get">
                            <div class="input-group">
                                <input type="text" name="search_query" @click="search= !search" class="form-control form-control-search" placeholder="Telusuri">
                                <button type="submit" class="input-group-text search-btn text-black"><i class="material-icons">search</i></button>
                            </div>
                        </form>
                        <div x-show="search" x-trap="search" class="card my-2 position-absolute history-search" style="border-radius: .75rem; z-index: 1;">
                            <div class="card-body search-btn for-search">
                                <div class="d-flex my-2 justify-content-between">
                                    ...
                                    <a href="" class="text-capitalize">hapus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a href="{{ route('redirect', 'google') }}" class="nav-link d-flex align-items-center text-black gap-2" style="background-color: #f1f1f1; padding: .5rem 1rem .5rem 1rem; border-radius: 1rem;">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" style="width: 250px; border-radius: 0.75rem;">
                                    ...
                                    <hr>
                                    <a href="{{ route('video.channel.index', ['channel' => Auth::user()->channel])}}" class="dropdown-item pb-3 text-black text-capitalize d-flex align-items-center">
                                        <div class="material-icons" style="margin-right: 0.75rem; font-size: 20px;">account_box</div>channel anda
                                    </a>
                                    <a href="{{ route('video.all', auth()->user()->channel) }}" class="dropdown-item pb-3 text-black text-capitalize d-flex align-items-center">
                                        <div class="material-icons" style="margin-right: 0.75rem; font-size: 20px;">subscriptions</div>youtube studio
                                    </a>
                                    <a class="dropdown-item text-black d-flex align-items-center" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
